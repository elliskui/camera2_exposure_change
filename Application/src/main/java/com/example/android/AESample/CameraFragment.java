...
package com.example.android.AESample;
...
//        mTextureView = view.findViewById(R.id.texture);
        mReticleView = view.findViewById(R.id.exposure_reticle);
    }
                    ...
                    mBackgroundHandler.post(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                //mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AE_REGIONS, meteringAreas);
                                ...
                                EVcurrent = -EVcurrent;
                                mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AE_EXPOSURE_COMPENSATION, EVcurrent);
                                Log.e(TAG, "EXPOSURE_COMPENSATION change to: " + EVcurrent);
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                //mCameraId = cameraId;
                mCameraId = "1";
                CameraCharacteristics t_character = manager.getCameraCharacteristics(cameraId);
                Range<Integer> range = t_character.get(CameraCharacteristics.CONTROL_AE_COMPENSATION_RANGE);
                Rational rational = t_character.get(CameraCharacteristics.CONTROL_AE_COMPENSATION_STEP);

                EVmax = range.getUpper();
                EVmin = range.getLower();
                EVcurrent = EVmax/2;
                double step = rational.doubleValue();

                Log.e(TAG, "camera AE_COMPENSATION_RANGE, max: " + EVmax + ", min: " + EVmin + ", step: " + step);
